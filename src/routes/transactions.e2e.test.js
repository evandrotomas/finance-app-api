...
describe('Transaction Routes E2E Tests', () => {
    ...
    it('PATCH /api/transaction/:transactionId should return 200 when updating a transaction successfully', async () => {
        const { body: createdUser } = await request(app)
            .post('/api/users')
            .send({
                ...user,
    ...
    it('GET /api/transaction?transactionId should return 404 fetching transactions from non-existing', async () => {
        const response = await request(app).get(
